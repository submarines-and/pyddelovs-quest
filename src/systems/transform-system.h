...
public:
    ...
    void update(Vector2d playerPosition)
    {
        ...
        for (auto e : entities) {
            ...
            transform.position.x += transform.direction.x * transform.speed - cameraPosition.x;
            transform.position.y += transform.direction.y * transform.speed - cameraPosition.y;
        }
    }
};